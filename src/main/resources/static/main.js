...
window.onload = () => {
    ...
    let showPhysicsForms = urlParams.get('admin');
    let formFrame = document.getElementById("physicFormFrame");
    if (showPhysicsForms === "true") {
        formFrame.src = "http://localhost:8080/form.html"
    } else {
